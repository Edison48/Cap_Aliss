...
package cap_talend_v2.df_ejercicio1_ds_2_5;
...
/**
 * Job: DF_Ejercicio1_DS Purpose: probar cosas nuevas<br>
 * Description: pruebitas 1.0.1 <br>
 * 
 * @author Salinas, Dalila
 * @version 8.0.1.20260319_1057-patch
 * @status TEST
 */
public class DF_Ejercicio1_DS implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "DF_Ejercicio1_DS.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(DF_Ejercicio1_DS.class);
	...
	private final String jobVersion = "2.5";
	private final String jobName = "DF_Ejercicio1_DS";
	private final String projectName = "CAP_TALEND_V2";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				DF_Ejercicio1_DS.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DF_Ejercicio1_DS.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_CAP_TALEND_V2_DF_Ejercicio1_DS = new byte[0];
		static byte[] commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS = new byte[0];
		...
		public Boolean CEDULAIsNullable() {
			return true;
		}

		public Boolean CEDULAIsKey() {
			return false;
		}

		public Integer CEDULALength() {
			return 10;
		}

		public Integer CEDULAPrecision() {
			return 0;
		}

		public String CEDULADefault() {

			return null;

		}

		public String CEDULAComment() {

			return "";

		}

		public String CEDULAPattern() {

			return "dd-MM-yyyy";

		}

		public String CEDULAOriginalDbColumnName() {
		...
		public String DIRECCION_CASA;

		public String getDIRECCION_CASA() {
			return this.DIRECCION_CASA;
		}

		public Boolean DIRECCION_CASAIsNullable() {
			return true;
		}

		public Boolean DIRECCION_CASAIsKey() {
			return false;
		}

		public Integer DIRECCION_CASALength() {
			return 16;
		}

		public Integer DIRECCION_CASAPrecision() {
			return 0;
		}

		public String DIRECCION_CASADefault() {

			return null;

		}

		public String DIRECCION_CASAComment() {

			return "";

		}

		public String DIRECCION_CASAPattern() {

			return "dd-MM-yyyy";

		}

		public String DIRECCION_CASAOriginalDbColumnName() {
		...
		public Boolean DIRECCION_OFICINAIsNullable() {
			return true;
		}

		public Boolean DIRECCION_OFICINAIsKey() {
			return false;
		}

		public Integer DIRECCION_OFICINALength() {
			return 16;
		}

		public Integer DIRECCION_OFICINAPrecision() {
			return 0;
		}

		public String DIRECCION_OFICINADefault() {

			return null;

		}

		public String DIRECCION_OFICINAComment() {

			return "";

		}

		public String DIRECCION_OFICINAPattern() {

			return "dd-MM-yyyy";

		}

		public String DIRECCION_OFICINAOriginalDbColumnName() {
		...
		public Boolean TELEFONO_CASAIsNullable() {
			return true;
		}

		public Boolean TELEFONO_CASAIsKey() {
			return false;
		}

		public Integer TELEFONO_CASALength() {
			return 8;
		}

		public Integer TELEFONO_CASAPrecision() {
			return 0;
		}

		public String TELEFONO_CASADefault() {

			return null;

		}

		public String TELEFONO_CASAComment() {

			return "";

		}

		public String TELEFONO_CASAPattern() {

			return "dd-MM-yyyy";

		}

		public String TELEFONO_CASAOriginalDbColumnName() {
		...
		public Boolean TELEFONO_OFICINAIsNullable() {
			return true;
		}

		public Boolean TELEFONO_OFICINAIsKey() {
			return false;
		}

		public Integer TELEFONO_OFICINALength() {
			return 8;
		}

		public Integer TELEFONO_OFICINAPrecision() {
			return 0;
		}

		public String TELEFONO_OFICINADefault() {

			return null;

		}

		public String TELEFONO_OFICINAComment() {

			return "";

		}

		public String TELEFONO_OFICINAPattern() {

			return "dd-MM-yyyy";

		}

		public String TELEFONO_OFICINAOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS.length) {
					if (length < 1024 && commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS.length == 0) {
						commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS = new byte[1024];
					} else {
						commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS, 0, length);
				strReturn = new String(commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS, 0, length);
				strReturn = new String(commonByteArray_CAP_TALEND_V2_DF_Ejercicio1_DS, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CAP_TALEND_V2_DF_Ejercicio1_DS) {
				...
				try {
					...
					this.DIRECCION_CASA = readString(dis);

					this.DIRECCION_OFICINA = readString(dis);

					this.TELEFONO_CASA = readString(dis);

					this.TELEFONO_OFICINA = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.DIRECCION_CASA, dos);

				// String

				writeString(this.DIRECCION_OFICINA, dos);

				// String

				writeString(this.TELEFONO_CASA, dos);

				// String

				writeString(this.TELEFONO_OFICINA, dos);
		...
		public String toString() {
			...
			sb.append(",DIRECCION_CASA=" + DIRECCION_CASA);
			sb.append(",DIRECCION_OFICINA=" + DIRECCION_OFICINA);
			sb.append(",TELEFONO_CASA=" + TELEFONO_CASA);
			sb.append(",TELEFONO_OFICINA=" + TELEFONO_OFICINA);
			sb.append("]");
		...
		public String toLogString() {
			...
			if (DIRECCION_CASA == null) {
				...
				sb.append(DIRECCION_CASA);
			}

			sb.append("|");

			if (DIRECCION_OFICINA == null) {
				sb.append("<null>");
			} else {
				sb.append(DIRECCION_OFICINA);
			}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_2", "w94f5U_");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLineage) {
					class ParameterUtil_tLogRow_1 {
						...
						public java.util.Map<String, String> getParameter(final row1Struct row1) throws Exception {
							java.util.Map<String, String> component_parameters = new java.util.HashMap<>();

							try {

								component_parameters.put("BASIC_MODE", String.valueOf("true"));
								component_parameters.put("TABLE_PRINT", String.valueOf("false"));
								component_parameters.put("VERTICAL", String.valueOf("false"));
								component_parameters.put("FIELDSEPARATOR", String.valueOf("|"));
								component_parameters.put("PRINT_HEADER", String.valueOf("false"));
								component_parameters.put("PRINT_UNIQUE_NAME", String.valueOf("false"));
								component_parameters.put("PRINT_COLNAMES", String.valueOf("false"));
								component_parameters.put("USE_FIXED_LENGTH", String.valueOf("false"));
								component_parameters.put("PRINT_CONTENT_WITH_LOG4J", String.valueOf("true"));

							} catch (java.lang.Exception e_tLogRow_1) {
								// do nothing
							}
					...
					talendJobLog.addComponentParameterMessage("tLogRow_1", "tLogRow",
							new ParameterUtil_tLogRow_1().getParameter(row1));
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				// QTUP-3575
...
///////////////////////    			
					...
					class BytesLimit65535_tFileInputDelimited_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_2
									.append("FILENAME" + " = " + "\"C:/Talend/DEV/BaseDeDatosERP/CLIENTE.csv\"");
							log4jParamters_tFileInputDelimited_2.append(" | ");
							...
							log4jParamters_tFileInputDelimited_2.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("CEDULA") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("NOMBRES") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("APELLIDOS")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DIRECCION_CASA") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("DIRECCION_OFICINA") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("TELEFONO_CASA") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("TELEFONO_OFICINA") + "}]");
							log4jParamters_tFileInputDelimited_2.append(" | ");
							...
							log4jParamters_tFileInputDelimited_2.append(" | ");
							log4jParamters_tFileInputDelimited_2.append("ENCODING" + " = " + "\"windows-1252\"");
							log4jParamters_tFileInputDelimited_2.append(" | ");
				...
				boolean init_tFileInputDelimited_2_0 = true;
				// QTUP-3575
				if (enableLineage) {
					class ParameterUtil_tFileInputDelimited_2 {
						...
						public java.util.Map<String, String> getParameter() throws Exception {
							...
							try {
								...
								component_parameters.put("USE_EXISTING_DYNAMIC", String.valueOf("false"));
								component_parameters.put("FILENAME",
										String.valueOf("C:/Talend/DEV/BaseDeDatosERP/CLIENTE.csv"));
								component_parameters.put("CSV_OPTION", String.valueOf("false"));
								component_parameters.put("ROWSEPARATOR", String.valueOf("\\n"));
								component_parameters.put("FIELDSEPARATOR", String.valueOf("|"));
								component_parameters.put("HEADER", String.valueOf("1"));
								component_parameters.put("FOOTER", String.valueOf("0"));
								component_parameters.put("LIMIT", String.valueOf(""));
								component_parameters.put("REMOVE_EMPTY_ROW", String.valueOf("false"));
								component_parameters.put("UNCOMPRESS", String.valueOf("false"));
								component_parameters.put("DIE_ON_ERROR", String.valueOf("false"));
								component_parameters.put("ADVANCED_SEPARATOR", String.valueOf("false"));
								component_parameters.put("RANDOM", String.valueOf("false"));
								component_parameters.put("TRIMALL", String.valueOf("false"));
								component_parameters.put("TRIMSELECT",
										String.valueOf(new StringBuilder().append("[{TRIM=").append("false")
												.append(", SCHEMA_COLUMN=").append("CEDULA").append("}, {TRIM=")
												.append("false").append(", SCHEMA_COLUMN=").append("NOMBRES")
												.append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=")
												.append("APELLIDOS").append("}, {TRIM=").append("false")
												.append(", SCHEMA_COLUMN=").append("DIRECCION_CASA").append("}, {TRIM=")
												.append("false").append(", SCHEMA_COLUMN=").append("DIRECCION_OFICINA")
												.append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=")
												.append("TELEFONO_CASA").append("}, {TRIM=").append("false")
												.append(", SCHEMA_COLUMN=").append("TELEFONO_OFICINA").append("}]")
												.toString()));
								component_parameters.put("CHECK_FIELDS_NUM", String.valueOf("false"));
								component_parameters.put("CHECK_DATE", String.valueOf("false"));
								component_parameters.put("ENCODING", String.valueOf("windows-1252"));
								component_parameters.put("SPLITRECORD", String.valueOf("false"));
								component_parameters.put("ENABLE_DECODE", String.valueOf("false"));
								component_parameters.put("DESTINATION", String.valueOf(""));
								component_parameters.put("USE_HEADER_AS_IS", String.valueOf("false"));

							} catch (java.lang.Exception e_tFileInputDelimited_2) {
								// do nothing
							}
					...
					talendJobLog.addComponentParameterMessage("tFileInputDelimited_2", "tFileInputDelimited",
							new ParameterUtil_tFileInputDelimited_2().getParameter());
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				// QTUP-3575
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_2", "CLIENTE", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Talend/DEV/BaseDeDatosERP/CLIENTE.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Talend/DEV/BaseDeDatosERP/CLIENTE.csv", "windows-1252", "|", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row1.CEDULA = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							row1.NOMBRES = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							row1.APELLIDOS = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row1.DIRECCION_CASA = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 4;

							row1.DIRECCION_OFICINA = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row1.TELEFONO_CASA = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row1.TELEFONO_OFICINA = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
						...
						// QTUP-3575
						if (enableLineage && init_tFileInputDelimited_2_0) {
							class SchemaUtil_row1 {
								...
								public java.util.List<java.util.Map<String, String>> getSchema(final row1Struct row1) {
									java.util.List<java.util.Map<String, String>> s = new java.util.ArrayList<>();
									if (row1 == null) {
										return s;
									}
									a(s, "CEDULA", "CEDULA", "false", "id_String", "null", "true", "dd-MM-yyyy", "10",
											"0");
									a(s, "NOMBRES", "NOMBRES", "false", "id_String", "null", "true", "dd-MM-yyyy", "12",
											"0");
									a(s, "APELLIDOS", "APELLIDOS", "false", "id_String", "null", "true", "dd-MM-yyyy",
											"15", "0");
									a(s, "DIRECCION_CASA", "DIRECCION_CASA", "false", "id_String", "null", "true",
											"dd-MM-yyyy", "16", "0");
									a(s, "DIRECCION_OFICINA", "DIRECCION_OFICINA", "false", "id_String", "null", "true",
											"dd-MM-yyyy", "16", "0");
									a(s, "TELEFONO_CASA", "TELEFONO_CASA", "false", "id_String", "null", "true",
											"dd-MM-yyyy", "8", "0");
									a(s, "TELEFONO_OFICINA", "TELEFONO_OFICINA", "false", "id_String", "null", "true",
											"dd-MM-yyyy", "8", "0");
									return s;
								}
							...
							if (row1 != null) {
								talendJobLog.addConnectionSchemaMessage("tFileInputDelimited_2", "tFileInputDelimited",
										"tLogRow_1", "tLogRow", "row1" + iterateId,
										new SchemaUtil_row1().getSchema(row1));
								talendJobLogProcess(globalMap);
								init_tFileInputDelimited_2_0 = false;
							}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_2", "CLIENTE", "tFileInputDelimited", "tLogRow_1",
									"tLogRow_1", "tLogRow"
...
///////////////////////		
							...
							if (row1.CEDULA != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.CEDULA));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.NOMBRES != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.NOMBRES));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.APELLIDOS != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.APELLIDOS));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.DIRECCION_CASA != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.DIRECCION_CASA));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.DIRECCION_OFICINA != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.DIRECCION_OFICINA));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.TELEFONO_CASA != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.TELEFONO_CASA));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.TELEFONO_OFICINA != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.TELEFONO_OFICINA));
...
///////////////////////    			
					...
					if (!((Object) ("C:/Talend/DEV/BaseDeDatosERP/CLIENTE.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_2", "CLIENTE", "tFileInputDelimited", "tLogRow_1", "tLogRow_1", "tLogRow",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final DF_Ejercicio1_DS DF_Ejercicio1_DSClass = new DF_Ejercicio1_DS();

		int exitCode = DF_Ejercicio1_DSClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'DF_Ejercicio1_DS' - Done.");
		}
	...
	private void readJobInfo(java.io.File jobInfoFile) {
		...
		log.info(String.format("Project name: %s\tJob name: %s\tGIT Commit ID: %s\tTalend Version: %s", projectName,
				jobName, jobInfo.getProperty("gitCommitId"), "8.0.1.20260319_1057-patch"));
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'DF_Ejercicio1_DS' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_WFAW0DnfEfGBC-dWxhApfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2026-04-16T22:21:51.320996500Z");
		...
		try {
			...
			java.io.InputStream inContext = DF_Ejercicio1_DS.class.getClassLoader()
					.getResourceAsStream("cap_talend_v2/df_ejercicio1_ds_2_5/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = DF_Ejercicio1_DS.class.getClassLoader()
		...
		log.info("TalendJob: 'DF_Ejercicio1_DS' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : DF_Ejercicio1_DS");
		}
		if (enableLogStash) {
		...
		if (!isChildJob) {
			...
			try {
				org.talend.studio.ProducerHelper.newPayload(payloadFilePath, lineageFilePath, taskExecId, taskId,
						taskVersion, lineageDirPath == null ? true : false);
			} catch (java.lang.Exception e) {
				e.printStackTrace();
			}
		}
		...
		log.info("TalendJob: 'DF_Ejercicio1_DS' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 97624 characters generated by Qlik Talend Cloud Enterprise Edition on the
 * April 16, 2026 at 5:21:51 PM ECT
 ************************************************************************************************/